...
export const Node = ({ className = "size-4" }: { className?: string }) => (
  <svg width="16" height="16" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round" className={className}>
